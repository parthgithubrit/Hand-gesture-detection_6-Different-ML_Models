...
json_file = open("C:\\Users\\parth\\Downloads\\modelcnnmp.json", "r")
model_json = json_file.read()
json_file.close()
model = model_from_json(model_json)
model.load_weights("C:\\Users\\parth\\Downloads\\modelcnnmp.h5")
...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        cv2.putText(frame,"Output: -"+' '.join(sentence)+''.join(accuracy), (3,25), 
